    	...
    	var widgetMainView = App.View.defaultView.extend({
            ...
            resizeWidgetHeight: function(params) {
                var self = this,
                    ...
                    widgetWidth = widgetParams.width || self.width,
                    widgetHeight = widgetParams.height || self.height,
                    widgetMinWidth = widgetParams.minWidth || self.minWidth;

                self.postMessage('action', {
                    method: 'resize',
                    arguments: [self.token, widgetWidth + 'px', widgetHeight + 'px', widgetMinWidth + 'px']
                });
            },
