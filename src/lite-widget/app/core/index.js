...
import defaultView from '../core/views/default-view';
import defaultCollection from '../core/collections/default-collection';
import defaultModel from '../core/models/default-model';
import defaultRouter from '../core/routers/default-router';
...
function addCss(cssArr) {
  if (App.config.environment.mode === 'local') {
    injectCss(cssArr);
  }
