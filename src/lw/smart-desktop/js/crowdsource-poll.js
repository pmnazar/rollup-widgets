...
import Form from '../../app/core/helpers/forms/parseForm';
import tpl from '../templates/crowdsource-poll.html';
import Ajax from '../../app/core/helpers/ajax';

const crowQuestionStep = App.View.defaultView.extend({
  el: '#body',
  resizeEvent: null,
...
const crowOptionsStep = App.View.defaultView.extend({
  el: '#body',
...
const crowSharingStep = App.View.defaultView.extend({
  el: '#body',
...
const crowRegStep = App.View.defaultView.extend({
  el: '#body',
...
const crowdDefaultView = App.View.defaultView.extend({
  el: '#pollContainer',
...
export default crowdDefaultView;
