...
function getPreparedData(xhrSettings) {
  var result = undefined,
    apiName =  xhrSettings.preparedDataApi ? xhrSettings.preparedDataApi :  xhrSettings.url.toString().replace(/(^.+\/)?/, '');
...
function cacheByDomain() {
  ...
  if (window.owPreparedData && typeof window.owPreparedData.urlArguments !== 'undefined' && window.owPreparedData.urlArguments.location) {
